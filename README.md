...
Spectrum is an [Ethereum-compatible](https://github.com/SmartMeshFoundation/Spectrum) project. It uses a new consensus and new block reward for SmartMesh ecosystem devices and IOT.You can view the transactions in the [
Block Chain Browser Address](https://spectrum.pub)
